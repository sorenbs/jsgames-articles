...
We use this to change the animation acordingly. The direction parameter in our callback will be an object of the form {x, y} specifying current movement along x- and y-axes.
...
We can get this information from private variables provided by the LeftControls component, but that is a bit clumpsy. 
...
Let's put two players on the map by extendign the main scene:
