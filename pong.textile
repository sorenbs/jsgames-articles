...
This is a simple game of Pong implemented with Crafty
...
window.onload = function() {
	...
	Crafty.e("2D, DOM, Color, Collision")
		.color('rgb(0,0,255)')
		.attr({x:350, y: 200, w:10, h:10, dX: Crafty.randRange(1,5), dY: Crafty.randRange(1,5)})
...
Building a LeftControls component is left as an exercise...
