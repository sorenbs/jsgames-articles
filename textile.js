function textile() {
	...
	var codeSegments = [byTagName('textile'), byTagName('tex'), byTagName('div')];
	var elements = [];
	...
	for (var i = 0; i < elements.length; i++) {
		elements[i].innerHTML = convert_textile(elements[i].innerHTML);
	}
...
*	FROM: https://github.com/miebach/js-textile
****************************************/
